...
public class Team {
    ...
    public Team(MadnessCup plugin, List<UUID> players, String teamName, String teamColor, Integer teamCoins, Integer teamLimit) {
        this.plugin = plugin;
    ...
    public void addPlayer(UUID player) {
        ...
        if ( this.players.size() >= this.teamLimit ) {
